...
# Generated on: Sun Nov 02 16:02:54 KST 2025 (Sun Nov 02 07:02:54 UTC 2025)
...
set logfile fv/ai_neuron_top_comp_v2_120/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/ai_neuron_top_comp_v2_120 -revised fv_map -use_rtl_names
...
read_design -verilog95   -revised -lastmod -noelab fv/ai_neuron_top_comp_v2_120/fv_map.v.gz
elaborate_design -revised -root {ai_neuron_top_comp_v2_120}
...
set_analyze_option -mapping_file fv/ai_neuron_top_comp_v2_120/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.ai_neuron_top_comp_v2_120.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ai_neuron_top_comp_v2_120.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ai_neuron_top_comp_v2_120.rtl.fv_map.rpt
